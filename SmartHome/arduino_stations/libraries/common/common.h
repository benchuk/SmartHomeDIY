...
#if defined(USE_RF_NANO_BOARD)
#define Radio_CSN 9   // MUST NOT BE CHANGED TO SUPPORT BOOTLOADER OTA
#define Radio_CE 10   // MUST NOT BE CHANGED TO SUPPORT BOOTLOADER OTA
