...
void enableRF(void) {
    ...
    */
    ...
    Mirf.configRegister(RF_SETUP, (1 << RF_PWR_LOW) | (1 << RF_PWR_HIGH) |
                                      (1 << RF_DR_LOW));
...
// void(* resetFunc) (void) = 0; //declare reset function @ address 0 // only
...
void loop() {
    ...
    //    "println" delay(20); // delay 200 milliseconds
    //  }
